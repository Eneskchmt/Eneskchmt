<!-- 👋 Animated Header -->
<!-- 💫 Animated Header -->
<h1 align="center">Hey there, I'm Enes Kocaahmet 👋</h1>
...
<p align="center">
  ...
  <a href="https://github.com/Eneskchmt" target="_blank">
...
- Improving backend architecture with **Node.js** and **Spring Boot**

### 🛠️ Technologies & Tools  
- **Frontend:** React, React Native, JavaScript, HTML, CSS  
- **Backend:** Node.js, Java, Spring Boot, PostgreSQL  
- **Other:** Git, GitHub, REST APIs, Tailwind CSS  

### 💡 About Me  
- 🎓 Graduated in **Computer Engineering** from *Karabük University*  
- 🎯 Completed the **Udemig Full Stack Web Development Program** (React Front-end, React Native, Node.js Backend)  
